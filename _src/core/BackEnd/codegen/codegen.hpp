...
class CodeGenerator
{
    ...
    private:
        ...
        void CompileImport(ImportNode* Node, CodeGenState& State, ByteCode& BC, SAResult& SARes, RunTimeData& Data, Arena& Memory);
        ...
        void CompileTernary(TernaryNode* Node, CodeGenState& State, ByteCode& BC, SAResult& SARes, RunTimeData& Data, Arena& Memory);
        ...
        void CompileRangeBuild(RangeBuildNode* Node, CodeGenState& State, ByteCode& BC, SAResult& SARes, RunTimeData& Data, Arena& Memory);
